...
class MagicTheGatheringTwoTestRunner
{
    ...
    {
        $live = self::getenv('MAGICTHEGATHERINGTWO_TEST_LIVE');
        $override = self::getenv('MAGICTHEGATHERINGTWO_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MAGICTHEGATHERINGTWO_TEST_EXPLAIN');
