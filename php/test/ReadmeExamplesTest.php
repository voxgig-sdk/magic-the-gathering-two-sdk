...
// MagicTheGatheringTwo SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MagicTheGatheringTwoSDK::test)
...
{
    private const SDK_CLASS = 'MagicTheGatheringTwoSDK';
    ...
    private const SDK_BASE = 'magicthegatheringtwo_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../magicthegatheringtwo_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
