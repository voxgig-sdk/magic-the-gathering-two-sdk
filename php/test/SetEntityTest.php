...
class SetEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MAGICTHEGATHERINGTWO_TEST_SET_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function set_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MAGICTHEGATHERINGTWO_TEST_SET_ENTID");
