...
class SupertypeEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MAGIC_THE_GATHERING_TWO_TEST_SUPERTYPE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function supertype_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MAGIC_THE_GATHERING_TWO_TEST_SUPERTYPE_ENTID");
