...
// MagicTheGatheringTwo SDK utility: make_options

class MagicTheGatheringTwoMakeOptions
{
    ...
    public static function call(MagicTheGatheringTwoContext $ctx): array
    {
        ...
        //
        // `MagicTheGatheringTwoSchema::optspec()` is built from the model:
        ...
        $optspec = MagicTheGatheringTwoSchema::optspec();
