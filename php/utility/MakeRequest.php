...
// MagicTheGatheringTwo SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MagicTheGatheringTwoMakeRequest
{
    public static function call(MagicTheGatheringTwoContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MagicTheGatheringTwoResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MagicTheGatheringTwoResponse($fetched);
        } else {
