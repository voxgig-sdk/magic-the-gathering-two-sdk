...
// MagicTheGatheringTwo SDK metrics feature
...
class MagicTheGatheringTwoMetricsFeature extends MagicTheGatheringTwoBaseFeature
{
    ...
    private function _record(MagicTheGatheringTwoContext $ctx, bool $ok): void
    {
