...
// MagicTheGatheringTwo SDK cache feature
...
class MagicTheGatheringTwoCacheFeature extends MagicTheGatheringTwoBaseFeature
{
    ...
    private function _through(MagicTheGatheringTwoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
