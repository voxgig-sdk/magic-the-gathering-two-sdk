...
// MagicTheGatheringTwo SDK rbac feature
...
class MagicTheGatheringTwoRbacFeature extends MagicTheGatheringTwoBaseFeature
{
    ...
    private function _required(MagicTheGatheringTwoContext $ctx): ?string
    {
    ...
    private function _reject(MagicTheGatheringTwoContext $ctx, string $required): void
    {
    ...
    private function _track(MagicTheGatheringTwoContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
