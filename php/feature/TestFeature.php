...
// MagicTheGatheringTwo SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MagicTheGatheringTwoTestFeature extends MagicTheGatheringTwoBaseFeature
{
    ...
    public function init(MagicTheGatheringTwoContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MagicTheGatheringTwoContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = MagicTheGatheringTwoParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MagicTheGatheringTwoContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MagicTheGatheringTwoContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = MagicTheGatheringTwoParam::call($ctx, $k);
