...
// MagicTheGatheringTwo SDK clienttrack feature
...
class MagicTheGatheringTwoClienttrackFeature extends MagicTheGatheringTwoBaseFeature
{
    ...
    public function PostConstruct(MagicTheGatheringTwoContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MagicTheGatheringTwo-SDK';
