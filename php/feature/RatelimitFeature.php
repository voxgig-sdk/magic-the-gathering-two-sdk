...
// MagicTheGatheringTwo SDK ratelimit feature
...
class MagicTheGatheringTwoRatelimitFeature extends MagicTheGatheringTwoBaseFeature
{
    ...
    private function _acquire(MagicTheGatheringTwoContext $ctx): void
    {
    ...
    private function _track(MagicTheGatheringTwoContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
