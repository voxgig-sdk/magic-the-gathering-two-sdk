...
// MagicTheGatheringTwo SDK audit feature
...
class MagicTheGatheringTwoAuditFeature extends MagicTheGatheringTwoBaseFeature
{
    ...
    private function _emit(MagicTheGatheringTwoContext $ctx, string $outcome): void
    {
