...
// MagicTheGatheringTwo SDK proxy feature
...
class MagicTheGatheringTwoProxyFeature extends MagicTheGatheringTwoBaseFeature
{
    ...
    public function init(MagicTheGatheringTwoContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MagicTheGatheringTwoContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
