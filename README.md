...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/magic-the-gathering-two` | `npm install @voxgig-sdk/magic-the-gathering-two` |
| Python | `voxgig-sdk-magic-the-gathering-two` | `pip install voxgig-sdk-magic-the-gathering-two` |
| PHP | `voxgig-sdk/magic-the-gathering-two` | `composer require voxgig-sdk/magic-the-gathering-two` |
| Golang | `github.com/voxgig-sdk/magic-the-gathering-two-sdk/go` | `go get github.com/voxgig-sdk/magic-the-gathering-two-sdk/go` |
| Ruby | `voxgig-sdk-magic-the-gathering-two` | `gem install voxgig-sdk-magic-the-gathering-two` |
| Lua | `voxgig-sdk-magic-the-gathering-two` | `luarocks install voxgig-sdk-magic-the-gathering-two` |
