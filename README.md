...
This API provides access to various endpoints related to Magic: The Gathering cards and sets.

Learn more about Magic The Gathering API at [magicthegathering.io](https://magicthegathering.io).
...
This SDK exposes the API as a small set of **semantic entities** — Card, Format, Set, SetBooster, Subtype, Supertype and Type — that you
...
| **Format** | The Format entity (list). | `/formats` |
| **Set** | The Set entity (list, load). | `/sets` |
| **SetBooster** | The SetBooster entity (list). | `/sets/{id}/booster` |
