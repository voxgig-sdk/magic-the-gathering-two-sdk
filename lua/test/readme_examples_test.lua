...
local SDK_MODULE = "magic-the-gathering-two_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["card"] = { ["test01"] = { id = "test01" } }, ["format"] = { ["test01"] = { id = "test01" } }, ["set"] = { ["test01"] = { id = "test01" } }, ["set_booster"] = { ["test01"] = { id = "test01" } }, ["subtype"] = { ["test01"] = { id = "test01" } }, ["supertype"] = { ["test01"] = { id = "test01" } }, ["type"] = { ["test01"] = { id = "test01" } } } }'
