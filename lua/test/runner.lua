...
function runner.env_override(m)
  local live = runner.getenv("MAGIC_THE_GATHERING_TWO_TEST_LIVE")
  local override = runner.getenv("MAGIC_THE_GATHERING_TWO_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MAGIC_THE_GATHERING_TWO_TEST_EXPLAIN")
