...
function runner.env_override(m)
  local live = runner.getenv("MAGICTHEGATHERINGTWO_TEST_LIVE")
  local override = runner.getenv("MAGICTHEGATHERINGTWO_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MAGICTHEGATHERINGTWO_TEST_EXPLAIN")
