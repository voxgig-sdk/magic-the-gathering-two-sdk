-- MagicTheGatheringTwo SDK SetBooster entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SetBoosterEntity = {}
SetBoosterEntity.__index = SetBoosterEntity


function SetBoosterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SetBoosterEntity)
  self._name = "set_booster"
  self._client = client
...
function SetBoosterEntity:get_name()
  return self._name
end


function SetBoosterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SetBoosterEntity.new(self._client, opts)
end
...
function SetBoosterEntity:mark_deleted()
  self._deleted = true
end


function SetBoosterEntity:deleted()
  return true == self._deleted
end


function SetBoosterEntity:data_set(args)
  if args ~= nil then
...
function SetBoosterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SetBoosterEntity:match_set(args)
  if args ~= nil then
...
function SetBoosterEntity:match_get()
...
function SetBoosterEntity:stream(action, args, callopts)
...
---@param reqmatch SetBoosterListMatch
---@param ctrl? table
---@return SetBooster[]
---@return string? err
function SetBoosterEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function SetBoosterEntity:_run_op(ctx, post_done)
  local utility = self._utility
