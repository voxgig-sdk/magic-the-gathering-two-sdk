...
The Lua SDK for the MagicTheGatheringTwo API. Provides an entity-oriented interface using Lua conventions.
...
local result, err = client:MagicTheGatheringTwo(nil):load(
  { id = "test01" }, nil
)
