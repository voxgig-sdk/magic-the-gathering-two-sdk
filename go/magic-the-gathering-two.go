...
// instead of `sdk.NewMagicTheGatheringTwoSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *MagicTheGatheringTwoSDK  { return NewMagicTheGatheringTwoSDK(nil) }
func Test() *MagicTheGatheringTwoSDK { return TestSDK(nil, nil) }
