...
## Install
```bash
go get github.com/voxgig-sdk/magic-the-gathering-two-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/magic-the-gathering-two-sdk=../path/to/github.com/voxgig-sdk/magic-the-gathering-two-sdk
```
...
```
github.com/voxgig-sdk/magic-the-gathering-two-sdk/
...
The root package (`github.com/voxgig-sdk/magic-the-gathering-two-sdk`) re-exports everything needed
