...
func TestCardEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set MAGIC_THE_GATHERING_TWO_TEST_CARD_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func cardBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("MAGIC_THE_GATHERING_TWO_TEST_CARD_ENTID")
	...
	idmapResolved := core.ToMapAny(env["MAGIC_THE_GATHERING_TWO_TEST_CARD_ENTID"])
