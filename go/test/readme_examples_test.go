...
const testSeed = `map[string]any{"entity": map[string]any{"card": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "format": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "set": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "set_booster": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subtype": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "supertype": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "type": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
