...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("MAGICTHEGATHERINGTWO_TEST_LIVE") == "TRUE" ||
		os.Getenv("MAGICTHEGATHERINGTWO_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("MAGICTHEGATHERINGTWO_TEST_EXPLAIN"); explain != "" {
