...
func TestSupertypeEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		supertypeRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.supertype")))
...
func supertypeBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("MAGIC_THE_GATHERING_TWO_TEST_SUPERTYPE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["MAGIC_THE_GATHERING_TWO_TEST_SUPERTYPE_ENTID"])
