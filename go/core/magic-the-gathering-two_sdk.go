...
type MagicTheGatheringTwoSDK struct {
	Mode     string
...
func (sdk *MagicTheGatheringTwoSDK) OptionsMap() map[string]any {
...
func (sdk *MagicTheGatheringTwoSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *MagicTheGatheringTwoSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *MagicTheGatheringTwoSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MagicTheGatheringTwoSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *MagicTheGatheringTwoSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *MagicTheGatheringTwoSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("MagicTheGatheringTwoSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *MagicTheGatheringTwoSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MagicTheGatheringTwoSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("MagicTheGatheringTwoSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *MagicTheGatheringTwoSDK {
	...
	sdk := NewMagicTheGatheringTwoSDK(sdkopts)
	sdk.Mode = "test"
