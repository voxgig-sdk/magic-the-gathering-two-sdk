...
func NewSetBoosterEntity(client *core.MagicTheGatheringTwoSDK, entopts map[string]any) *SetBoosterEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SetBoosterEntity) GetName() string { return e.name }
...
func (e *SetBoosterEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SetBoosterEntity) Deleted() bool {
	return e.deleted
}


func (e *SetBoosterEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSetBoosterEntity(e.client, opts)
}

func (e *SetBoosterEntity) Data(args ...any) any {
...
func (e *SetBoosterEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SetBooster; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SetBoosterEntity) DataTyped(data ...SetBooster) SetBooster {
	if len(data) > 0 {
		return typedFrom[SetBooster](e.Data(asMap(data[0])))
	}
	return typedFrom[SetBooster](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SetBooster (all fields
// optional at the wire level).
func (e *SetBoosterEntity) MatchTyped(match ...SetBooster) SetBooster {
	if len(match) > 0 {
		return typedFrom[SetBooster](e.Match(asMap(match[0])))
	}
	return typedFrom[SetBooster](e.Match())
}
...
func (e *SetBoosterEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SetBoosterEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SetBoosterEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SetBoosterListMatch and returns []SetBooster. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SetBoosterEntity) ListTyped(reqmatch SetBoosterListMatch, ctrl map[string]any) ([]SetBooster, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[SetBooster](res), nil
}



func (e *SetBoosterEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SetBoosterEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SetBoosterEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SetBoosterEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
