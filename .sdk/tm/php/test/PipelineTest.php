...
// MagicTheGatheringTwo SDK pipeline test
//
...
{
    private static function utility(): MagicTheGatheringTwoUtility
    {
        return new MagicTheGatheringTwoUtility();
    }
    ...
    private static function ctx(array $over = []): MagicTheGatheringTwoContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MagicTheGatheringTwoContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MagicTheGatheringTwoOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MagicTheGatheringTwoError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MagicTheGatheringTwoOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MagicTheGatheringTwoMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MagicTheGatheringTwoOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MagicTheGatheringTwoMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MagicTheGatheringTwoOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MagicTheGatheringTwoMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MagicTheGatheringTwoSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MagicTheGatheringTwoMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MagicTheGatheringTwoResponse([]),
            'result' => new MagicTheGatheringTwoResult([]),
        ]);
        [, $err] = MagicTheGatheringTwoMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MagicTheGatheringTwoSpec([]),
            'response' => null,
            'result' => new MagicTheGatheringTwoResult([]),
        ]);
        [, $err] = MagicTheGatheringTwoMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MagicTheGatheringTwoSpec(['step' => 's']),
            'response' => new MagicTheGatheringTwoResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MagicTheGatheringTwoResult([]),
        ]);
        [, $err] = MagicTheGatheringTwoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MagicTheGatheringTwoSpec(['step' => 's']),
            'response' => new MagicTheGatheringTwoResponse(self::resp(200, ['v' => 1])),
            'result' => new MagicTheGatheringTwoResult([]),
        ]);
        [, $err] = MagicTheGatheringTwoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MagicTheGatheringTwoSpec(['step' => 's']),
            'response' => new MagicTheGatheringTwoResponse(self::resp(200, ['v' => 2])),
            'result' => new MagicTheGatheringTwoResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MagicTheGatheringTwoMakeResponse::call($ctx);
    ...
    {
        $preset = new MagicTheGatheringTwoResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MagicTheGatheringTwoSpec([]),
            'response' => new MagicTheGatheringTwoResponse([]),
            'result' => new MagicTheGatheringTwoResult([]),
        ...
        [$got, $err] = MagicTheGatheringTwoMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MagicTheGatheringTwoResult([])]);
        [, $err] = MagicTheGatheringTwoMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MagicTheGatheringTwoSpec([]), 'result' => null]);
        [, $err] = MagicTheGatheringTwoMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MagicTheGatheringTwoSpec(['step' => 's']),
            'result' => new MagicTheGatheringTwoResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MagicTheGatheringTwoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MagicTheGatheringTwoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MagicTheGatheringTwoSpec(['step' => 's']),
            'result' => new MagicTheGatheringTwoResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MagicTheGatheringTwoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MagicTheGatheringTwoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MagicTheGatheringTwoResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MagicTheGatheringTwoSpec([]),
            'result' => new MagicTheGatheringTwoResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MagicTheGatheringTwoMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MagicTheGatheringTwoMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MagicTheGatheringTwoError('boom', 'boom');
        $utility->fetcher = function (MagicTheGatheringTwoContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MagicTheGatheringTwoSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MagicTheGatheringTwoMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MagicTheGatheringTwoContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MagicTheGatheringTwoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MagicTheGatheringTwoResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MagicTheGatheringTwoMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MagicTheGatheringTwoContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MagicTheGatheringTwoSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MagicTheGatheringTwoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MagicTheGatheringTwoResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MagicTheGatheringTwoSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MagicTheGatheringTwoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MagicTheGatheringTwoMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MagicTheGatheringTwoMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MagicTheGatheringTwoResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MagicTheGatheringTwoDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MagicTheGatheringTwoResult(['ok' => false])]);
        $this->expectException(MagicTheGatheringTwoError::class);
        MagicTheGatheringTwoDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MagicTheGatheringTwoResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MagicTheGatheringTwoMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MagicTheGatheringTwoMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MagicTheGatheringTwoBaseFeature();
        $b = new MagicTheGatheringTwoBaseFeature();
        MagicTheGatheringTwoFeatureAdd::call($ctx, $a);
        MagicTheGatheringTwoFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MagicTheGatheringTwoBaseFeature
    {
        $f = new MagicTheGatheringTwoBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MagicTheGatheringTwoFeatureAdd::call($ctx, self::named_feature('a'));
        MagicTheGatheringTwoFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        MagicTheGatheringTwoFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        MagicTheGatheringTwoFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        MagicTheGatheringTwoFeatureAdd::call($ctx, $replace);
        ...
        MagicTheGatheringTwoFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MagicTheGatheringTwoContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MagicTheGatheringTwoSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MagicTheGatheringTwoPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MagicTheGatheringTwoPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MagicTheGatheringTwoResponse(['headers' => null]),
            'result' => new MagicTheGatheringTwoResult([]),
        ]);
        MagicTheGatheringTwoResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MagicTheGatheringTwoResultBody::call($ctx);
