...
// MagicTheGatheringTwo SDK utility type

class MagicTheGatheringTwoUtility
{
    ...
    public static function copy(MagicTheGatheringTwoUtility $src): MagicTheGatheringTwoUtility
    {
        $u = new MagicTheGatheringTwoUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
