...
// MagicTheGatheringTwo SDK utility: result_basic

class MagicTheGatheringTwoResultBasic
{
    public static function call(MagicTheGatheringTwoContext $ctx): ?MagicTheGatheringTwoResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof MagicTheGatheringTwoError) ? $result->err->msg : (string)$result->err;
