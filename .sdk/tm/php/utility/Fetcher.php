...
// MagicTheGatheringTwo SDK utility: fetcher

class MagicTheGatheringTwoFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MagicTheGatheringTwoSDK/1.0)';
    ...
    public static function call(MagicTheGatheringTwoContext $ctx, string $fullurl, array $fetchdef): array
    {
