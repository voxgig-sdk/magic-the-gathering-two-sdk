...
// MagicTheGatheringTwo SDK utility: graphql
//
...
class MagicTheGatheringTwoGraphql
{
    ...
    // equivalent.
    public static function body(MagicTheGatheringTwoContext $ctx): mixed
    {
    ...
    public static function errors(MagicTheGatheringTwoContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
