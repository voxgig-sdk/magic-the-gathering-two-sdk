...
// MagicTheGatheringTwo SDK netsim feature
...
class MagicTheGatheringTwoNetsimFeature extends MagicTheGatheringTwoBaseFeature
{
    ...
    private function _simulate(MagicTheGatheringTwoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MagicTheGatheringTwoContext $ctx, array $applied): void
    {
        $client = $this->client;
