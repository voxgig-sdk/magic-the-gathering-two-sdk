...
// MagicTheGatheringTwo SDK timeout feature
...
class MagicTheGatheringTwoTimeoutFeature extends MagicTheGatheringTwoBaseFeature
{
    ...
    private function _with_timeout(MagicTheGatheringTwoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MagicTheGatheringTwoContext $_ctx, float $ms): void
    {
        $client = $this->client;
