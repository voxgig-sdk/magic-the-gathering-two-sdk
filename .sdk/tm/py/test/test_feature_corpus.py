# MagicTheGatheringTwo SDK feature corpus test
#
...
def _client(kase):
    ...
    MagicTheGatheringTwoSDK(...), not MagicTheGatheringTwoSDK.test(...): the `test` feature is
    ...
    return MagicTheGatheringTwoSDK(opts)
