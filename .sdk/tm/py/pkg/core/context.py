...
from projectname_sdk.core.control import MagicTheGatheringTwoControl
...
class MagicTheGatheringTwoContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = MagicTheGatheringTwoControl()
        ...
        if isinstance(sp, MagicTheGatheringTwoSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MagicTheGatheringTwoResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MagicTheGatheringTwoResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return MagicTheGatheringTwoOperation({})
        ...
        op = MagicTheGatheringTwoOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return MagicTheGatheringTwoError(code, msg, self)
