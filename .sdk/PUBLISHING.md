...
|---|---|---|
| `ts/` | @voxgig-sdk/magic-the-gathering-two-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/magic-the-gathering-two-sdk \
      --repository voxgig-sdk/magic-the-gathering-two-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/magic-the-gathering-two-sdk` shows it, and
`npm trust revoke @voxgig-sdk/magic-the-gathering-two-sdk --id=<id>` removes it.
