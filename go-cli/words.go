...
func registerSDKWords(r *eng.Registry, client *sdk.MagicTheGatheringTwoSDK) {
...
func runOp(client *sdk.MagicTheGatheringTwoSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
