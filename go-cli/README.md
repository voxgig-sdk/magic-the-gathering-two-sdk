...
AQL-driven CLI and REPL for the MagicTheGatheringTwo SDK. Positional arguments are
...
```sh
go build -o magic-the-gathering-two-cli ./...
```
...
./magic-the-gathering-two-cli load 1 card
./magic-the-gathering-two-cli load '{id:1}' card
