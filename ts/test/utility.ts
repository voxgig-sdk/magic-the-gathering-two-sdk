...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.MAGICTHEGATHERINGTWO_TEST_LIVE ||
    'TRUE' === process.env.MAGICTHEGATHERINGTWO_TEST_OVERRIDE
  ) {
  ...
  m.MAGICTHEGATHERINGTWO_TEST_EXPLAIN = process.env.MAGICTHEGATHERINGTWO_TEST_EXPLAIN || m.MAGICTHEGATHERINGTWO_TEST_EXPLAIN
