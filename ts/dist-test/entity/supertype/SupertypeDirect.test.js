...
(0, node_test_1.describe)('SupertypeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-supertype', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-supertype', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MAGIC_THE_GATHERING_TWO_TEST_SUPERTYPE_ENTID'];
...
//# sourceMappingURL=SupertypeDirect.test.js.map