...
(0, node_test_1.describe)('SetBoosterDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MagicTheGatheringTwoSDK({
    ...
    (0, node_test_1.test)('direct-list-set_booster', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-set_booster', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["set_booster01"]))
            return;
...
function liveScenariosActive() { return false && process.env.MAGIC_THE_GATHERING_TWO_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MagicTheGatheringTwoSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['MAGIC_THE_GATHERING_TWO_TEST_SET_BOOSTER_ENTID'];
    ...
    const client = new __1.MagicTheGatheringTwoSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SetBoosterDirect.test.js.map