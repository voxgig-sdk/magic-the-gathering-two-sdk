...
(0, node_test_1.describe)('SubtypeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-subtype', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-subtype', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'MAGIC_THE_GATHERING_TWO_TEST_SUBTYPE_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['MAGIC_THE_GATHERING_TWO_TEST_SUBTYPE_ENTID'];
...
//# sourceMappingURL=SubtypeDirect.test.js.map