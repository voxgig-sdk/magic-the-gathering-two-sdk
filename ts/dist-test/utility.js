...
function envOverride(m) {
    if ('TRUE' === process.env.MAGIC_THE_GATHERING_TWO_TEST_LIVE ||
        'TRUE' === process.env.MAGIC_THE_GATHERING_TWO_TEST_OVERRIDE) {
    ...
    m.MAGIC_THE_GATHERING_TWO_TEST_EXPLAIN = process.env.MAGIC_THE_GATHERING_TWO_TEST_EXPLAIN || m.MAGIC_THE_GATHERING_TWO_TEST_EXPLAIN;
    return m;
}
