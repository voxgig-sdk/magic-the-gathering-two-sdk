...
type Args struct {
	Entity string         `json:"entity" jsonschema:"card | format | set | set_booster | subtype | supertype | type"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MagicTheGatheringTwoSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "magic-the-gathering-two_list",
		Description: "List records from MagicTheGatheringTwo. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "magic-the-gathering-two_load",
		Description: "Load a single record from MagicTheGatheringTwo. " +
...
func runOp(client *sdk.MagicTheGatheringTwoSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MagicTheGatheringTwoSDK, name string) (sdk.MagicTheGatheringTwoEntity, error) {
	...
	case "set_booster":
		return client.SetBooster(nil), nil
	case "subtype":
