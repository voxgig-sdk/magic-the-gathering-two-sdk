// Command MagicTheGatheringTwo-mcp is an MCP server exposing the MagicTheGatheringTwo
// SDK as MCP tools.
//
// Two tools are registered:
//
//	MagicTheGatheringTwo_list  — list records of an entity
//	MagicTheGatheringTwo_load  — load a single record of an entity
//
