# MagicTheGatheringTwo SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MagicTheGatheringTwoSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MagicTheGatheringTwoSDK(...) and MagicTheGatheringTwoSDK.test(...) become
#      MagicTheGatheringTwoSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "magicthegatheringtwo_sdk"
_SDK_CLASS = "MagicTheGatheringTwoSDK"
