...
from magicthegatheringtwo_sdk.utility import register

# Load features
from magicthegatheringtwo_sdk.feature.base_feature import MagicTheGatheringTwoBaseFeature
from magicthegatheringtwo_sdk.features import _has_feature, _make_feature
...
class MagicTheGatheringTwoSDK:
    ...
    def __init__(self, options=None):
        ...
        from magicthegatheringtwo_sdk.config import shared_config
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MagicTheGatheringTwoSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def SetBooster(self, data=None) -> "SetBoosterEntity":
        ...
        from magicthegatheringtwo_sdk.entity.set_booster_entity import SetBoosterEntity
    ...
    def Subtype(self, data=None) -> "SubtypeEntity":
        ...
        from magicthegatheringtwo_sdk.entity.subtype_entity import SubtypeEntity
    ...
    def Supertype(self, data=None) -> "SupertypeEntity":
        ...
        from magicthegatheringtwo_sdk.entity.supertype_entity import SupertypeEntity
        return SupertypeEntity(self, data)


    def Type(self, data=None) -> "TypeEntity":
        """Entity factory: client.Type().list() / client.Type().load({"id": ...})."""
        from magicthegatheringtwo_sdk.entity.type_entity import TypeEntity
        return TypeEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "MagicTheGatheringTwoSDK":
        if sdkopts is None:
            sdkopts = {}
