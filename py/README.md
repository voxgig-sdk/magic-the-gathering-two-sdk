...
The Python SDK for the MagicTheGatheringTwo API. Provides an entity-oriented interface following Pythonic conventions.
...
result, err = client.MagicTheGatheringTwo(None).load(
    {"id": "test01"}, None
)
