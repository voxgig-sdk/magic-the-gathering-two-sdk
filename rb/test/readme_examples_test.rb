...
#      offline in seeded test mode (MagicTheGatheringTwoSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "MagicTheGatheringTwo_sdk.rb")
  SDK_CLASS = "MagicTheGatheringTwoSDK"
  ...
  SDK_BASE = "MagicTheGatheringTwo_sdk"
