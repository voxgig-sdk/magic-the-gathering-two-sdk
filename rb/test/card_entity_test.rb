...
class CardEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MAGICTHEGATHERINGTWO_TEST_CARD_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def card_basic_setup(extra)
  ...
  entid_env_raw = ENV["MAGICTHEGATHERINGTWO_TEST_CARD_ENTID"]
  ...
  idmap_resolved = Helpers.to_map(
    env["MAGICTHEGATHERINGTWO_TEST_CARD_ENTID"])
