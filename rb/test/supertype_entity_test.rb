...
class SupertypeEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MAGICTHEGATHERINGTWO_TEST_SUPERTYPE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def supertype_basic_setup(extra)
  ...
  entid_env_raw = ENV["MAGICTHEGATHERINGTWO_TEST_SUPERTYPE_ENTID"]
