...
class SupertypeEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MAGIC_THE_GATHERING_TWO_TEST_SUPERTYPE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def supertype_basic_setup(extra)
  ...
  entid_env_raw = ENV["MAGIC_THE_GATHERING_TWO_TEST_SUPERTYPE_ENTID"]
  ...
  idmap_resolved = Helpers.to_map(
    env["MAGIC_THE_GATHERING_TWO_TEST_SUPERTYPE_ENTID"])
