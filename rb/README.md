...
The Ruby SDK for the MagicTheGatheringTwo API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
```ruby
gem "magic-the-gathering-two-sdk"
```
...
result, err = client.MagicTheGatheringTwo(nil).load(
  { "id" => "test01" }, nil
)
