# MagicTheGatheringTwo SDK Format entity
...
class FormatEntity
  ...
  #
  # @param reqmatch [FormatListMatch, Hash, nil] match filter (any subset of Format fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Format>, Array] the matching Format items; raises MagicTheGatheringTwoError on failure
