# MagicTheGatheringTwo SDK Set entity
...
class SetEntity
  ...
  # @return [Set, Hash] the loaded Set; raises MagicTheGatheringTwoError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Set>, Array] the matching Set items; raises MagicTheGatheringTwoError on failure
